...
# CORS is open only for local development unless explicitly enabled in production.
CORS_ALLOW_CREDENTIALS = False
CORS_ALLOW_ALL_ORIGINS = DEBUG or os.getenv("CORS_ALLOW_ALL_ORIGINS", "False").lower() in {
    "1", "true", "yes", "on"
}
