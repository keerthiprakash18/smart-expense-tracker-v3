...
import { BarChart3, Bell, CircleDollarSign, LayoutDashboard, LogOut, Plus, ReceiptText, RefreshCw, Settings, WalletCards, WandSparkles } from 'lucide-react';
...
export default function AppShell() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="build-tag">SMART EXPENSE • V3</div>
    </aside>
    ...
    <main className="app-main">
      <header className="topbar">
        ...
        <button className="icon-button" onClick={() => navigate('/notifications')} title="Notifications"><Bell size={18}/></button>
